...
public class bus_dataformSQlite {
	private int i = 0;
	private List<Map<String, Object>> list;
	private Object obj;
	private Context mcontext;

	public bus_dataformSQlite(Context context) {
		mcontext = context;
	}

	public void sendRequest(final bus_ServerListener listener) {
		final int num = i;
		if (i < 2) {
...
//			try {
//				readdata rd = new readdata(mcontext, "bus.db");
//				
//				Cursor cur  =null;
//				if(i==0) cur= rd.fetchData("busInfo", "type", "'工作日'");
//				if(i==1) cur= rd.fetchData("busInfo", "type", "周五");
//				if(i==2) cur= rd.fetchData("busInfo", "type", "周末");
//				if(i==3) cur= rd.fetchData("busInfo", "type", "节假日");
//				//Cursor cur = rd.fetchData("busInfo", 43);
