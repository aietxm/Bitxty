...
public class life_phoneActivity1 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mData = CategoryData.getData1(this);
        
        LayoutInflater inflater = LayoutInflater.from(this);
//        LinearLayout header=null;
//        try
//        {
//          header = (LinearLayout)inflater.inflate(R.layout.life_phoneheader, null);
//        }
//        catch (Exception e) {
//			int i=0;i++;
//		}
...
//        view.startAnimation(mAnimationScale);
    ...
    private AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView<?> parent, View v, int position, long id)
        {
            ...
            intent.setClass(life_phoneActivity1.this, life_phoneActivity2.class);
