...
import com.pulllist.DialogLoading;
...
public class rss_LoginActivity extends Activity {
...
//	private ImageView imagView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.rss_login);
...
//		};
		...
		loginButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				intent = new Intent();
				intent.setClass(rss_LoginActivity.this, rss_ActivityMain.class);
				//锟斤拷锟斤拷锟竭筹拷
				thread.start();
