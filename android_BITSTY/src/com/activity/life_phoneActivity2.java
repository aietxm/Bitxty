...
public class life_phoneActivity2 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mData = CategoryData.getData2(this,pidtype );
...
//        view.startAnimation(mAnimationScale);
    ...
    private AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView<?> parent, View v, int position, long id)
        {
            ...
            intent.setClass(life_phoneActivity2.this, life_phoneActivity3.class);
            intent.putExtra("pidtype",(String)mData.get(position).get("sid"));
            intent.putExtra("location",(String)mData.get(position).get("location"));
