	...
	public class GridAdapter extends BaseAdapter 
	{
		...
		public View getView(int paramInt, View paramView, ViewGroup paramViewGroup) 
		{
			...
			switch(paramInt)
			{
				...
				{
					text.setText("校园电话");	
					Drawable draw = getResources().getDrawable(R.drawable.menu_phone);
				...
				{
					text.setText("活动信息");	
					Drawable draw = getResources().getDrawable(R.drawable.menu_events);
					draw.setBounds(0, 0, draw.getIntrinsicWidth(), draw.getIntrinsicHeight());
					text.setCompoundDrawables(null, draw, null, null);
					break;
				}
				...
				{
					text.setText("失物招领");	
					Drawable draw = getResources().getDrawable(R.drawable.menu_lost);
					draw.setBounds(0, 0, draw.getIntrinsicWidth(), draw.getIntrinsicHeight());
					text.setCompoundDrawables(null, draw, null, null);
					break;
				}
