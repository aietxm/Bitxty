...
public class mainRss extends Activity {
...
//		getWindow().setBackgroundDrawableResource(R.drawable.background);
		...
		boolean clickble = intent.getBooleanExtra("clickble", true);
	      ...
	      home_img_bn_Layout = (LinearLayout) findViewById(R.id.bottom_home_layout_ly);
	        ...
	        show_img_bn_layout.setSelected(clickble);
	...
	private AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() {
		public void onItemClick(AdapterView<?> parent, View v, int position,long id) {
			...
			intent.setClass(mainRss.this, com.activity.rss_ActivityMain.class);
	...
	public class GridAdapter extends BaseAdapter 
	{
		...
		public View getView(int paramInt, View paramView, ViewGroup paramViewGroup) 
		{
			...
			Drawable draw = getResources().getDrawable(logo);			draw.setBounds(0, 0, draw.getIntrinsicWidth(), draw.getIntrinsicHeight());
	  ...
	  private OnClickListener clickListener_home = new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
					...
					Intent intent = new Intent();
					intent.setClass(mainRss.this, mainface.class);
					startActivity(intent);
			}
		};
		private OnClickListener clickListener_style = new OnClickListener() {
			...
			public void onClick(View v) {
				...
				show_img_bn_layout.setSelected(false);
				Intent intent = new Intent();
				intent.setClass(mainRss.this, mainPT.class);
				startActivity(intent);
			}
		};
		private OnClickListener clickListener_cam = new OnClickListener() {
			...
			public void onClick(View v) {
				...
				show_img_bn_layout.setSelected(false);
				Intent intent = new Intent();
				intent.setClass(mainRss.this, mainMore.class);
				startActivity(intent);
			}
		};
		private OnClickListener clickListener_shopping = new OnClickListener() {
			...
			public void onClick(View v) {
				...
				show_img_bn_layout.setSelected(false);
				Intent intent = new Intent();
				intent.setClass(mainRss.this, mainschoolife.class);
				startActivity(intent);
